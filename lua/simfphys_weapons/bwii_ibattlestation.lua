	-- Variables --
local class = "bwii_ibattlestation"
local icon = "entities/bwii_ibattlestation.png"
local name = "Battlestation"
local TEAM = TEAM_LEGION
local driverFPPos = Vector(0,-30,0)
local driverTPPos = Vector(0,0,150)
...
local fireSound = "cpthazama/bwii/ironlegion/VU_Batt_Fire.wav"
local fireSoundVolume = 150
local fireSoundPitch = 100

local reloadSoundTime = 4
...
local secondSound = "cpthazama/bwii/ironlegion/WU_Baz_Fire.wav"
...
local ppTurretPitchAddition = -15
...
local tblVOAttack = {
	"cpthazama/bwii/ironlegion/grunt/CV_LG_Attack_02.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_Attack_03.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_Attack_04.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_Attack_05.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_AttNS_02.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_AttNS_03.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_AttNS_04.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_AttNS_05.wav",
}

local tblVOIdle = {
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_02.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_03.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_04.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_05.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_06.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_07.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_08.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_09.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banter_10.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_02.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_03.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_04.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_05.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_06.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_07.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_08.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_09.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterguard_10.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_02.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_03.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_04.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_05.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_06.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_07.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_08.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_09.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_10.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_11.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_12.wav",
	"cpthazama/bwii/ironlegion/grunt/CV_LG_banterspecific_13.wav",
}
...
local function primary_fire(ply,vehicle,shootOrigin,shootDirection,shootOrigin2,shootDirection2)
	...
	projectile.Entity = "avx_tankprojectile_bwii_legion"
	
	local pro = AVX.FirePhysProjectile_Return(projectile)
	pro:SetNWInt("Effect",1)
...
function simfphys.weapon:Think( vehicle )
	...
	if self:CanVO_Idle(vehicle) then
		self:DoGruntVoices(vehicle,tblVOIdle)
	end
...
function simfphys.weapon:DoGruntVoices(vehicle,tbl)
	...
	if IsValid(driver) then
		if tbl == tblVOIdle then
			driver:EmitSound(tbl[math.random(1,#tbl)],80,100)
			self:SetNextVO_Idle(math.Rand(5,15))
		elseif tbl == tblVOAttack then
			driver:EmitSound(tbl[math.random(1,#tbl)],85,100)
			self:SetNextVO_Attack(math.Rand(5,15))
		end
	end
end

function simfphys.weapon:CanVO_Idle(vehicle)
	self.voTime_Idle = self.voTime_Idle or 0
	return self.voTime_Idle < CurTime()
end

function simfphys.weapon:CanVO_Attack(vehicle)
	self.voTime_Attack = self.voTime_Attack or 0
	return self.voTime_Attack < CurTime()
end

function simfphys.weapon:CanVO_Pain(vehicle)
	self.voTime_Pain = self.voTime_Pain or 0
	return self.voTime_Pain < CurTime()
end

function simfphys.weapon:SetNextVO_Idle(time)
	if self.voTime_Idle == nil then self.voTime_Idle = CurTime() end
	self.voTime_Idle = CurTime() +time
end

function simfphys.weapon:SetNextVO_Attack(time)
	if self.voTime_Attack == nil then self.voTime_Attack = CurTime() end
	self.voTime_Attack = CurTime() +time
end

function simfphys.weapon:SetNextVO_Pain(time)
	if self.voTime_Pain == nil then self.voTime_Pain = CurTime() end
	self.voTime_Pain = CurTime() +time
end

function simfphys.weapon:PrimaryAttack( vehicle, ply, shootOrigin, Attachment, shootOrigin2, Attachment2 )
	if not self:CanPrimaryAttack( vehicle ) then return end
	if self:CanVO_Attack(vehicle) then
		self:DoGruntVoices(vehicle,tblVOAttack)
	end
...
function simfphys.weapon:UpdateSuspension( vehicle )
	...
	for i = 1,#tblSuspensionData do
		...
		vehicle:SetPoseParameter(name .. "_sus",math.Clamp(Dist,-5,5))
	end
end
...
function simfphys.weapon:DoWheelSpin( vehicle )
	...
	vehicle:SetPoseParameter("rwheel", -spin_r /2)
	vehicle:SetPoseParameter("rbwheel", -spin_r /2)
	vehicle:SetPoseParameter("lwheel", -spin_l /2 )
	vehicle:SetPoseParameter("lbwheel", -spin_l /2 )
	vehicle:SetPoseParameter("cwheel", -(spin_l +spin_r) /2 )
