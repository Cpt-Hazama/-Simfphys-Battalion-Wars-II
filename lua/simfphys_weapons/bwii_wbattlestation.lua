	-- Variables --
local class = "bwii_wbattlestation"
local icon = "entities/bwii_wbattlestation.png"
local name = "Battlestation"
local TEAM = TEAM_FRONTIER
local driverFPPos = Vector(0,-10,8)
local driverTPPos = Vector(50,0,0)
local driverFollowerAttachment = true
local crosshairDirection = Vector(0,90,0)
local lCannonFPPos = Vector(0,0,8)
local lCannonTPPos = Vector(0,0,0)
local rCannonFPPos = Vector(0,0,8)
local rCannonTPPos = Vector(0,0,0)
...
local secondSound = "cpthazama/bwii/westernfrontier/WW_Baz_Fire.wav"
...
function simfphys.weapon:Initialize( vehicle )
	...
	-- local pos,ang = vehicle:GetBonePosition(3) -- l
	-- local vec = vehicle:WorldToLocal(pos)
	-- print("Vector("..vec.x..","..vec.y..","..vec.z..")")
	-- local pos,ang = vehicle:GetBonePosition(4) -- lb
	-- local vec = vehicle:WorldToLocal(pos)
	-- print("Vector("..vec.x..","..vec.y..","..vec.z..")")
	-- local pos,ang = vehicle:GetBonePosition(5) -- r
	-- local vec = vehicle:WorldToLocal(pos)
	-- print("Vector("..vec.x..","..vec.y..","..vec.z..")")
	-- local pos,ang = vehicle:GetBonePosition(6) -- rb
	-- local vec = vehicle:WorldToLocal(pos)
	-- print("Vector("..vec.x..","..vec.y..","..vec.z..")")
	...
	simfphys.RegisterCamera( vehicle.pSeat[1], lCannonFPPos, lCannonTPPos, false, nil )

	simfphys.RegisterCrosshair( vehicle.pSeat[2] , { Attachment = "rCannon", Type = 3 } )
	simfphys.RegisterCamera( vehicle.pSeat[2], rCannonFPPos, rCannonTPPos, false, nil )

	simfphys.RegisterCrosshair( vehicle.pSeat[3] , { Attachment = "lTurret", Type = 1 } )
	simfphys.RegisterCamera( vehicle.pSeat[3], Vector(0,0,0), Vector(0,0,15), false, nil )

	simfphys.RegisterCrosshair( vehicle.pSeat[4] , { Attachment = "rTurret", Type = 1 } )
	simfphys.RegisterCamera( vehicle.pSeat[4], Vector(0,0,0), Vector(0,0,15), false, nil )

	simfphys.RegisterCrosshair( vehicle.pSeat[5] , { Attachment = "cTurret", Type = 1 } )
	simfphys.RegisterCamera( vehicle.pSeat[5], Vector(0,0,8), Vector(0,0,15), false, nil )
