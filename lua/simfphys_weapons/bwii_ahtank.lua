	-- Variables --
local class = "bwii_ahtank"
local icon = "entities/bwii_ahtank.png"
local name = "Heavy Tank"
local TEAM = TEAM_ANGLO
local driverFPPos = Vector(-105,-45,-10)
local driverTPPos = Vector(0,0,80)
...
function simfphys.weapon:ControlTurret( vehicle, deltapos )
	...
	local ID = vehicle:LookupAttachment( "mL" )
	local Attachment = vehicle:GetAttachment( ID )
	
	local ID2 = vehicle:LookupAttachment( "mR" )
