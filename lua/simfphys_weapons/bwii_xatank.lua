	-- Variables --
local class = "bwii_xatank"
local icon = "entities/bwii_xatank.png"
local name = "Advanced Tank"
local TEAM = TEAM_XYLVANIA
local driverFPPos = Vector(0,-5,10)
...
local mainForceOnVehicle = 600000
local mainDMG = BWII_DMG_ADVANCEDTANK
local mainForce = 10000
local mainEffectSize = 25
local mainRadius = 350
local mainRadiusDMG = BWII_DMG_ADVANCEDTANK /20

local secondaryAttachment = "turret"
local secondaryCooldown = 0.1
local ppSideTurretYaw = "t_yaw"
...
local function primary_fire(ply,vehicle,shootOrigin,shootDirection)
	...
	vehicle:EmitSound("cpthazama/bwii/westernfrontier/VW_HTank_Fire.wav", fireSoundVolume, fireSoundPitch)
