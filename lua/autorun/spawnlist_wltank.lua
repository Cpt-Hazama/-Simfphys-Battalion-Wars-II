local V = {
	Name = "Light Tank",
	Model = "models/cpthazama/bwii/westernfrontier/lighttank.mdl",
	...
	Members = {
		...
		CustomWheelPosFL = Vector(90,45,48),
		CustomWheelPosFR = Vector(90,-45,48),
		CustomWheelPosML = Vector(5,45,48),
		CustomWheelPosMR = Vector(5,-45,48),
		CustomWheelPosRL = Vector(-100,45,48),
		CustomWheelPosRR = Vector(-100,-45,48),
		...
		Sound_Idle = "cpthazama/bwii/xylvania/lighttank_idle.wav",
		Sound_IdlePitch = 0.5,
...
list.Set( "simfphys_vehicles", "bwii_wltank", V )