...
list.Set( "simfphys_lights", "bwii_xhrecon", light_table)

local V = {
	Name = "Heavy Recon",
	Model = "models/cpthazama/bwii/xylvania/heavyrecon.mdl",
...
list.Set( "simfphys_vehicles", "bwii_xhrecon", V )