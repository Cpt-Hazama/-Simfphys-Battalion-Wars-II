...
list.Set( "simfphys_lights", "srecon", light_table)

local V = {
	Name = "Light Recon",
	Model = "models/cpthazama/bwii/solarempire/lightrecon.mdl",
	...
	Members = {
		...
		Sound_Idle = "cpthazama/bwii/solarempire/VS_HTank_Eng1.wav",
		Sound_IdlePitch = 1.1,
		Sound_IdleVolume = 1,
...
list.Set( "simfphys_vehicles", "bwii_srecon", V )