local V = {
	Name = "Light Tank",
	Model = "models/cpthazama/bwii/ironlegion/lighttank.mdl",
	...
	Members = {
		...
		Sound_Idle = "cpthazama/bwii/ironlegion/VU_HTank_Eng2.wav",
		Sound_IdlePitch = 1,
		
		Sound_Mid = "cpthazama/bwii/ironlegion/VU_HTank_Eng1.wav",
		Sound_MidPitch = 1,
		Sound_MidVolume = 1,
		Sound_MidFadeOutRPMpercent = 58,
		Sound_MidFadeOutRate = 0.476,
		
		Sound_High = "cpthazama/bwii/ironlegion/VU_HTank_Eng2.wav",
		Sound_HighPitch = 1,
		Sound_HighVolume = 1,
...
list.Set( "simfphys_vehicles", "bwii_iltank", V )